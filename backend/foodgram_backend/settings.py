...
SECRET_KEY = 'django-insecure-91+8sc-1=5-jk_9dp9^___-v8k7vao(2s071b(6^ocvprbr*0v'

DEBUG = False

ALLOWED_HOSTS = ['158.160.176.237', 'localhost', '127.0.0.1']
